...
echo "Starting consumer for queue.podcast-analysis-tool.query-term"
...
$HOME/lib/kafka_2.12-2.5.0/bin/kafka-console-consumer.sh --bootstrap-server localhost:9092 --topic queue.podcast-analysis-tool.query-term --from-beginning \

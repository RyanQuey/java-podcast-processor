...
public class M20200529151500CreateEpisodesByPodcastTable {
  public static void run () throws Exception {
    ...
    try {
      ...
      String episodeTable = "CREATE TABLE IF NOT EXISTS podcast_analysis_tool.episodes_by_podcast (" + 
          "podcast_api TEXT, " + 
          "podcast_api_id TEXT, " + 
          "episode_guid TEXT, " + 
      ...
      System.out.println("ran migration M20200529151500CreateEpisodesByPodcastTable");

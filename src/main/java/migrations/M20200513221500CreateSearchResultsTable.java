...
public class M20200513221500CreateSearchResultsTable {
  ...
  public static void run () throws InvalidQueryException {
    ...
    try {
      ...
      db.execute("CREATE TABLE IF NOT EXISTS podcast_analysis_tool.search_results_by_term (term TEXT, search_type TEXT, result_json TEXT, external_api TEXT, updated_at TIMESTAMP, PRIMARY KEY ((term), search_type, external_api));");
